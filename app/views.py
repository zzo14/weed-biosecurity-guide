    ...
    if request.method == 'POST':
        ...
        try: 
            if gardener_id:
                ...
                direct_to = url_for('gardener_list')
            else:
                target_id = id
                direct_to = url_for('gardener_profile')
...
@app.route('/update_SA_profile', defaults={'staff_id': None}, methods=['GET', 'POST'])
@app.route('/update_SA_profile/<int:staff_id>', methods=['GET', 'POST'])
...
@app.route('/staff_list/add_new_staff',  methods=['GET', 'POST'])
def add_new_staff():
    connection = getCursor()
    if request.method == 'POST':
        username = request.form.get('username')
...
@app.route('/staff_list/delete_staff/<int:staff_id>', methods=['GET', 'POST'])
...
@app.route('/staff_list/recover_staff_account/<int:staff_id>',methods=['GET', 'POST'])
