...
@admin_staff.route(
    "/update_SA_profile", defaults={"staff_id": None}, methods=["GET", "POST"]
)
...
@admin_staff.route(
    "/gardener_list/delete_gardener/<int:gardener_id>", methods=["GET", "POST"]
)
...
@admin_staff.route(
    "/gardener_list/recover_gardener_account/<int:gardener_id>", methods=["GET", "POST"]
)
...
@admin_staff.route(
    "/staff_list/recover_staff_account/<int:staff_id>", methods=["GET", "POST"]
)
